...
clc; clear all;
m = input('Enter the no of nodes in x direction : '); % the number of nodes in X-dir
n = input('Enter the no of nodes in y direction : '); % the number of nodes in Y-dir
L = input('Enter the Total length : '); % the length of cross-sectional dimensions
W = input('Enter the Total width : '); % the width of cross-sectional dimensions
